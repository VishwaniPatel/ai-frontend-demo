...
const OptionItem = ({
  ...
  <div
    onClick={onClick}
    className={classNames("cursor-pointer flex-grow-1 option col", className, {
      active,
    })}
  >
    {children}
...
const SettingsModal = ({ handleClose, show = false }) => {
  ...
  const { color, layout, radius, navColor } = useSelector(
          ...
          >
              ...
              <>
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.LightBlue)
                    }
                  >
                  ...
                  <OptionItem
                    label="DARK BLUE"
                    active={color === THEME_COLOR.DarkBlue}
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.DarkBlue)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                ...
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.LightGreen)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                  ...
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.DarkGreen)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                ...
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.LightPink)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                  ...
                  <OptionItem
                    label="DARK PINK"
                    active={color === THEME_COLOR.DarkPink}
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.DarkPink)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                ...
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.LightPurple)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                  ...
                  <OptionItem
                    ...
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.DarkPurple)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                ...
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem
                    label="LIGHT RED"
                    active={color === THEME_COLOR.LightRed}
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.LightRed)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                  ...
                  <OptionItem
                    label="DARK RED"
                    active={color === THEME_COLOR.DarkRed}
                    onClick={() =>
                      handleChange(settingsChangeColor, THEME_COLOR.DarkRed)
                    }
                  >
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
            ...
            <OptionGroup label="Override Nav Palette">
              <>
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(settingsChangeNavColor, NAV_COLOR.Default)
                  }
                >
                ...
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(settingsChangeNavColor, NAV_COLOR.Light)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                ...
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(settingsChangeNavColor, NAV_COLOR.Dark)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
            ...
            <OptionGroup label="Menu Placement">
              <>
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(menuChangePlacement, MENU_PLACEMENT.Horizontal)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                    <Figure className="figure-primary top" />
                ...
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(menuChangePlacement, MENU_PLACEMENT.Vertical)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
            ...
            <OptionGroup label="Menu Behaviour">
              <>
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(menuChangeBehaviour, MENU_BEHAVIOUR.Pinned)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                ...
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(menuChangeBehaviour, MENU_BEHAVIOUR.Unpinned)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                    <Figure className="figure-primary left" />
            ...
            <OptionGroup label="Layout">
              <>
                <OptionItem
                  label="FLUID"
                  active={layout === LAYOUT.Fluid}
                  onClick={() =>
                    handleChange(settingsChangeLayout, LAYOUT.Fluid)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                    <Figure className="figure-primary top" />
                ...
                <OptionItem
                  label="BOXED"
                  active={layout === LAYOUT.Boxed}
                  onClick={() =>
                    handleChange(settingsChangeLayout, LAYOUT.Boxed)
                  }
                >
                  <Card className="rounded-md p-3 mb-1 no-shadow">
                    <Figure className="figure-primary top" />
            ...
            <OptionGroup label="Radius">
              <>
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(settingsChangeRadius, RADIUS.Rounded)
                  }
                >
                ...
                <OptionItem
                  ...
                  onClick={() =>
                    handleChange(settingsChangeRadius, RADIUS.Standard)
                  }
                >
                ...
                <OptionItem
                  label="FLAT"
                  active={radius === RADIUS.Flat}
                  onClick={() =>
                    handleChange(settingsChangeRadius, RADIUS.Flat)
                  }
                >
