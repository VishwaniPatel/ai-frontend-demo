...
const pages = {
  ...
  miscellaneous: {
    ...
    knowledgeBase: lazy(() =>
      import("./views/pages/miscellaneous/KnowledgeBase")
    ),
...
const interfaces = {
  ...
  forms: {
    ...
    validation: lazy(() =>
      import("./views/interface/forms/validation/Validation")
    ),
    wizard: lazy(() => import("./views/interface/forms/wizard/Wizard")),
    inputGroup: lazy(() =>
      import("./views/interface/forms/input-group/InputGroup")
    ),
    inputMask: lazy(() =>
      import("./views/interface/forms/input-mask/InputMask")
    ),
    genericForms: lazy(() =>
      import("./views/interface/forms/generic-forms/GenericForms")
    ),
    controls: {
      index: lazy(() => import("./views/interface/forms/controls/Controls")),
      autocomplete: lazy(() =>
        import("./views/interface/forms/controls/autocomplete/Autocomplete")
      ),
      checkboxRadio: lazy(() =>
        import("./views/interface/forms/controls/checkbox-radio/CheckboxRadio")
      ),
      datePicker: lazy(() =>
        import("./views/interface/forms/controls/datepicker/Datepicker")
      ),
      dropzone: lazy(() =>
        import("./views/interface/forms/controls/dropzone/Dropzone")
      ),
      editor: lazy(() =>
        import("./views/interface/forms/controls/editor/Editor")
      ),
      inputSpinner: lazy(() =>
        import("./views/interface/forms/controls/input-spinner/InputSpinner")
      ),
      rating: lazy(() =>
        import("./views/interface/forms/controls/rating/Rating")
      ),
      select: lazy(() =>
        import("./views/interface/forms/controls/select/Select")
      ),
      slider: lazy(() =>
        import("./views/interface/forms/controls/slider/Slider")
      ),
  ...
  plugins: {
    ...
    contextMenu: lazy(() =>
      import("./views/interface/plugins/context-menu/ContextMenu")
    ),
    datatables: {
      index: lazy(() =>
        import("./views/interface/plugins/datatables/Datatables")
      ),
      editableRows: lazy(() =>
        import("./views/interface/plugins/datatables/EditableRows/EditableRows")
      ),
      editableBoxed: lazy(() =>
        import(
          "./views/interface/plugins/datatables/EditableBoxed/EditableBoxed"
        )
      ),
      serverSide: lazy(() =>
        import("./views/interface/plugins/datatables/ServerSide/ServerSide")
      ),
      boxedVariations: lazy(() =>
        import(
          "./views/interface/plugins/datatables/BoxedVariations/BoxedVariations"
        )
      ),
    },
    ...
    notification: lazy(() =>
      import("./views/interface/plugins/notification/Notification")
    ),
    players: lazy(() => import("./views/interface/plugins/player/Player")),
    progress: lazy(() => import("./views/interface/plugins/progress/Progress")),
    scrollbar: lazy(() =>
      import("./views/interface/plugins/scrollbar/Scrollbar")
    ),
    shortcuts: lazy(() =>
      import("./views/interface/plugins/shortcut/Shortcut")
    ),
  ...
  content: {
    ...
    icons: {
      ...
      csLineIcons: lazy(() =>
        import("./views/interface/content/icons/CsLineIcons")
      ),
      csInterfaceIcons: lazy(() =>
        import("./views/interface/content/icons/CsInterfaceIcons")
      ),
      bootstrapIcons: lazy(() =>
        import("./views/interface/content/icons/BootstrapIcons")
      ),
    },
    ...
    menu: {
      ...
      horizontal: lazy(() =>
        import("./views/interface/content/menu/Horizontal")
      ),
      vertical: lazy(() => import("./views/interface/content/menu/Vertical")),
      verticalHidden: lazy(() =>
        import("./views/interface/content/menu/VerticalHidden")
      ),
      verticalNoHidden: lazy(() =>
        import("./views/interface/content/menu/VerticalNoHidden")
      ),
      mobileOnly: lazy(() =>
        import("./views/interface/content/menu/MobileOnly")
      ),
  ...
  mainMenuItems: [
          ...
          subs: [
            {
              path: "/faq",
              label: "menu.faq",
              component: pages.miscellaneous.faq,
            },
            {
              path: "/knowledge-base",
              label: "menu.knowledge-base",
              component: pages.miscellaneous.knowledgeBase,
            },
            {
              path: "/error",
              label: "menu.error",
              component: pages.miscellaneous.error,
              noLayout: true,
            },
            {
              path: "/coming-soon",
              label: "menu.coming-soon",
              component: pages.miscellaneous.comingSoon,
              noLayout: true,
            },
            {
              path: "/pricing",
              label: "menu.pricing",
              component: pages.miscellaneous.pricing,
            },
            {
              path: "/search",
              label: "menu.search",
              component: pages.miscellaneous.search,
            },
            {
              path: "/mailing",
              label: "menu.mailing",
              component: pages.miscellaneous.mailing,
            },
            {
              path: "/empty",
              label: "menu.empty",
              component: pages.miscellaneous.empty,
            },
          ],
        },
        {
          ...
          subs: [
            {
              path: "/home",
              label: "menu.home",
              component: pages.portfolio.home,
            },
            {
              path: "/detail",
              label: "menu.detail",
              component: pages.portfolio.detail,
            },
          ],
        },
        {
          ...
          subs: [
            {
              path: "/standard",
              label: "menu.standard",
              component: pages.profile.standard,
            },
            {
              path: "/settings",
              label: "menu.settings",
    ...
    },
    {
      ...
      subs: [
        ...
        {
          path: "/tabular-data",
          label: "menu.tabular-data",
          component: blocks.tabularData,
        },
        {
          path: "/thumbnails",
          label: "menu.thumbnails",
          component: blocks.thumbnails,
        },
      ],
    },
    {
          ...
          subs: [
            {
              ...
              component: interfaces.components.accordion,
            },
            {
              path: "/alerts",
              label: "menu.alerts",
              component: interfaces.components.alerts,
            },
            {
              path: "/badge",
              label: "menu.badge",
              component: interfaces.components.badge,
            },
            {
              path: "/breadcrumb",
              label: "menu.breadcrumb",
              component: interfaces.components.breadcrumb,
            },
            {
              path: "/buttons",
              label: "menu.buttons",
              component: interfaces.components.buttons,
            },
            {
              path: "/button-group",
              label: "menu.button-group",
              component: interfaces.components.buttonGroup,
            },
            {
              path: "/card",
              label: "menu.card",
              component: interfaces.components.card,
            },
            {
              path: "/close-button",
              label: "menu.close-button",
              component: interfaces.components.closeButton,
            },
            {
              path: "/collapse",
              label: "menu.collapse",
              component: interfaces.components.collapse,
            },
            {
              path: "/dropdowns",
              label: "menu.dropdowns",
              component: interfaces.components.dropdowns,
            },
            {
              path: "/list-group",
              label: "menu.list-group",
              component: interfaces.components.listGroup,
            },
            {
              path: "/modal",
              label: "menu.modal",
              component: interfaces.components.modal,
            },
            {
              path: "/navs",
              label: "menu.navs",
              component: interfaces.components.navs,
            },
            {
              path: "/offcanvas",
              label: "menu.offcanvas",
              component: interfaces.components.offcanvas,
            },
            {
              path: "/pagination",
              label: "menu.pagination",
              component: interfaces.components.pagination,
            },
            {
              path: "/popovers",
              label: "menu.popovers",
              component: interfaces.components.popovers,
            },
            {
              path: "/progress",
              label: "menu.progress",
              component: interfaces.components.progress,
            },
            {
              path: "/spinners",
              label: "menu.spinners",
              component: interfaces.components.spinners,
            },
            {
              path: "/toasts",
              label: "menu.toasts",
              component: interfaces.components.toasts,
            },
            {
              path: "/tooltips",
              label: "menu.tooltips",
              component: interfaces.components.tooltips,
            },
          ],
        },
        {
          ...
          subs: [
            {
              path: "/layouts",
              label: "menu.layouts",
              component: interfaces.forms.layouts,
            },
            {
              path: "/validation",
            ...
            },
            {
              path: "/wizard",
              label: "menu.wizard",
              component: interfaces.forms.wizard,
            },
            {
              path: "/input-group",
              label: "menu.input-group",
              component: interfaces.forms.inputGroup,
            },
            {
              path: "/input-mask",
              label: "menu.input-mask",
              component: interfaces.forms.inputMask,
            },
            {
              path: "/generic-forms",
              label: "menu.generic-forms",
              component: interfaces.forms.genericForms,
            },
            {
              path: "/controls",
              label: "menu.controls",
              ...
              subs: [
                ...
                {
                  path: "/date-picker",
                  label: "menu.date-picker",
                  component: interfaces.forms.controls.datePicker,
                },
                {
                  path: "/dropzone",
                  label: "menu.dropzone",
                  component: interfaces.forms.controls.dropzone,
                },
                {
                  path: "/editor",
                  label: "menu.editor",
                  component: interfaces.forms.controls.editor,
                },
                {
                  path: "/input-spinner",
                ...
                },
                {
                  path: "/rating",
                  label: "menu.rating",
                  component: interfaces.forms.controls.rating,
                },
                {
                  path: "/select",
                  label: "menu.select",
                  component: interfaces.forms.controls.select,
                },
                {
                  path: "/slider",
                  label: "menu.slider",
                  component: interfaces.forms.controls.slider,
                },
                {
                  path: "/tags",
                  label: "menu.tags",
                  component: interfaces.forms.controls.tags,
                },
              ],
            },
          ],
          ...
          subs: [
            {
              path: "/carousel",
              label: "menu.carousel",
              component: interfaces.plugins.carousel,
            },
            {
              path: "/charts",
              label: "menu.charts",
              component: interfaces.plugins.charts,
            },
            {
              path: "/clamp",
              label: "menu.clamp",
              component: interfaces.plugins.clamp,
            },
            {
              path: "/context-menu",
              label: "menu.context-menu",
              component: interfaces.plugins.contextMenu,
            },
            {
              path: "/datatables",
            ...
            },
            {
              path: "/lightbox",
              label: "menu.lightbox",
              component: interfaces.plugins.lightbox,
            },
            {
              path: "/maps",
              label: "menu.maps",
              component: interfaces.plugins.maps,
            },
            {
              path: "/notification",
              label: "menu.notification",
              component: interfaces.plugins.notification,
            },
            {
              path: "/players",
              label: "menu.players",
              component: interfaces.plugins.players,
            },
            {
              path: "/progress",
              label: "menu.progress",
              component: interfaces.plugins.progress,
            },
            {
              path: "/scrollbar",
              label: "menu.scrollbar",
              component: interfaces.plugins.scrollbar,
            },
            {
              path: "/shortcuts",
              label: "menu.shortcuts",
              component: interfaces.plugins.shortcuts,
            },
            {
              path: "/sortable",
              label: "menu.sortable",
              component: interfaces.plugins.sortable,
            },
          ],
        },
        {
          ...
          subs: [
            ...
            },
            {
              path: "/images",
              label: "menu.images",
              component: interfaces.content.images,
            },
            {
              path: "/tables",
              label: "menu.tables",
              component: interfaces.content.tables,
            },
            {
              path: "/typography",
              label: "menu.typography",
              component: interfaces.content.typography,
            },
            {
              path: "/menu",
              label: "menu.menu",
              ...
              subs: [
                {
                  ...
                  component: interfaces.content.menu.horizontal,
                },
                {
                  path: "/vertical",
                  label: "menu.vertical",
                  component: interfaces.content.menu.vertical,
                },
                {
                ...
                {
                  path: "/mobile-only",
                  label: "menu.mobile-only",
                  component: interfaces.content.menu.mobileOnly,
                },
                {
                  path: "/sidebar",
                  label: "menu.sidebar",
                  component: interfaces.content.menu.sidebar,
                },
              ],
            },
          ],
