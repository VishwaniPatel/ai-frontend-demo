            ...
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink
                  ...
                  className="heading stretched-link d-block"
                >
                  Default
                </NavLink>
                <div className="text-muted">
                  Home screen that contains stats, charts, call to action
                  buttons and various listing elements.
                </div>
              </Col>
            </Card.Body>
          </Card>
          ...
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                ...
                <div className="text-muted">
                  A dashboard implementation that mainly has visual items such
                  as banners, call to action buttons and stats.
                </div>
              </Col>
            </Card.Body>
          </Card>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink
                  to="/dashboards/analytic"
                  className="heading stretched-link d-block"
                >
                  Analytic
                </NavLink>
                <div className="text-muted">
                  Another dashboard alternative that focused on data, listing
                  and charts.
                </div>
              </Col>
            </Card.Body>
